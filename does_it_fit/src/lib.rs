pub fn area_fit(
    ...
    let total_area = (times as f64) * shape_area;
    total_area.ceil() <= container_area
}
...
pub fn volume_fit(
    ...
    let shape_volume = match kind {
        ...
        areas_volumes::GeometricalVolumes::TriangularPyramid => {
            let base_area = areas_volumes::triangle_area(a, a) as f64;
    ...
    let total_volume = (times as f64) * shape_volume;
    total_volume.ceil() <= container_volume
}